...
async def scrape_job(request: ScrapeRequest):
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            # Always close the browser, even if navigation/extraction raises —
            # otherwise each failed scrape leaks a browser process.
            try:
        ...
        if not content or not content.strip():
            raise HTTPException(status_code=502, detail="Scraper returned empty content")
